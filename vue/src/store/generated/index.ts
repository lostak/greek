...
import LostakGreekLostakGreekAlpha from './lostak/greek/lostak.greek.alpha'
...
export default { 
  ...
  LostakGreekLostakGreekAlpha: load(LostakGreekLostakGreekAlpha, 'lostak.greek.alpha'),
