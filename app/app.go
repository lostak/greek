...
import (
	...
	"github.com/lostak/greek/docs"
	alphamodule "github.com/lostak/greek/x/alpha"
	alphamodulekeeper "github.com/lostak/greek/x/alpha/keeper"
	alphamoduletypes "github.com/lostak/greek/x/alpha/types"
...
func New(
	...
	app.AlphaKeeper = *alphamodulekeeper.NewKeeper(
		appCodec,
		keys[alphamoduletypes.StoreKey],
		keys[alphamoduletypes.MemStoreKey],
		app.GetSubspace(alphamoduletypes.ModuleName),
	)
	alphaModule := alphamodule.NewAppModule(appCodec, app.AlphaKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(alphamoduletypes.ModuleName)
